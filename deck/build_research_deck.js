...
/* 2 HER WORDS */{const s=light(); eyebrow(s,"Where we started"); title(s,"Your words, first");
  ...
  note(s,6.0,"So I went through everything properly before replying. This is what I found.");}
...
/* 3 THE WORKING */{const s=light(); eyebrow(s,"Before anything else"); title(s,"What I actually went through");
  ...
  bl(s,["Your grid — the covers, the hooks, the pattern across them","Your captions, and the way you write them",
    "Your Stories, including the growth poll and the laptop teaser",
    "Your Threads — your posts and the replies you've written",
  ...
  bl(s,["@upgradingkatie — her grid, her pinned trio, her comment sections, her manifesto post",
  ...
  s.addText([{text:"I didn't want to come back with a ",options:{color:WHITE}},{text:"generic pitch",options:{color:GOLD,bold:true}},
...
/* 4 WHERE YOU ARE */{const s=light(); eyebrow(s,"Starting point"); title(s,"You're doing more right than you think");
  ...
  note(s,6.05,"The problem isn't effort. It's that the effort is going in five directions at once.");
  foot(s,"These are the public numbers on the day I looked. I haven't seen your Insights — your reach, your saves, where your followers actually come from. That's the first thing I'd want to go through with you.");}
...
/* 5 FIVE SURFACES */{const s=light(); eyebrow(s,"Pattern 01"); title(s,"Five places you show up. Five different Juhis.");
  const rows=[["Your bio","Overcome burnout · Mindset · Healing · Confidence"],
    ["Most of your posts","Save your marriage"],
...
/* 10 SWOT */{const s=light(); eyebrow(s,"The honest picture"); title(s,"SWOT");
  [["STRENGTHS",GREEN,GREENBG,M,1.9,["100+ women coached — real experience behind you",
      ...
      "You're building this while raising two kids — you are your audience"]],
...
/* 11 KATIE */{const s=light(); eyebrow(s,"The account you sent me"); title(s,"Katie is you, about twelve months ahead");
  ...
  s.addText("You're at the same stage, with the same life. Same idea.",{x:7.47,y:4.05,w:4.8,h:0.55,margin:0,fontFace:BF,fontSize:15,bold:true,color:BERRY,lineSpacing:20});
...
/* 17 WHERE IT GOES */{const s=light(); eyebrow(s,"One shoot, three homes"); title(s,"Where the content goes, and why");
  const pl=[["Instagram","DISCOVERY",TINT,INK,BERRY,MUTED,
      "Where strangers find you. Reels travel fastest and engage harder than Shorts do.",
    ...
    ["YouTube","WHERE YOUR AUDIENCE ACTUALLY IS",BERRY,WHITE,GOLD,MUTEDD,
      "467 million monthly users in India — behind only WhatsApp and Facebook. And it reaches the 25–34 group far more strongly.",
